...
func TestNormalizeInstallFlagsDefaults(t *testing.T) {
	...
	want := model.Selection{
		...
		Persona: model.PersonaSeniorZaBaDeV,
...
func TestNormalizeInstallFlagsMapsLegacyGentlemanToSeniorZaBaDeV(t *testing.T) {
	input, err := NormalizeInstallFlags(InstallFlags{Persona: "gentleman"}, system.DetectionResult{})
	if err != nil {
		t.Fatalf("NormalizeInstallFlags() error = %v", err)
	}

	if input.Selection.Persona != model.PersonaSeniorZaBaDeV {
		t.Fatalf("persona = %q, want %q", input.Selection.Persona, model.PersonaSeniorZaBaDeV)
	}
}
...
func TestNormalizeInstallFlagsAcceptsSeniorZaBaDeVPersona(t *testing.T) {
	input, err := NormalizeInstallFlags(InstallFlags{Persona: "senior-zabadev"}, system.DetectionResult{})
	if err != nil {
		t.Fatalf("NormalizeInstallFlags() error = %v", err)
	}
	if input.Selection.Persona != model.PersonaSeniorZaBaDeV {
