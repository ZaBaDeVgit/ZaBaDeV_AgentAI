...
| Persona | `persona` | ZaBaDeV, neutral, or custom behavior mode |
| Permissions | `permissions` | Security-first defaults and guardrails |
| GGA | `gga` | ZaBaDeV Guardian Angel — AI provider switcher |
| Theme | `theme` | ZaBaDeV Kanagawa theme overlay |
...
|--------|-----|-----------------|
| Full ZaBaDeV | `full-gentleman` | All components + all skills + ZaBaDeV persona |
| Ecosystem Only | `ecosystem-only` | All components + P0 skills + ZaBaDeV persona |
