...
|---------|-----|-------------|
| Senior ZaBaDeV | `senior-zabadev` | Single primary persona — principal-engineer posture, stronger ownership, memory-first workflow, and OpenCode SDD orchestration |
...
| `--persona` | Persona mode: `senior-zabadev`, `neutral`, `custom` (`gentleman` is accepted as a legacy alias) |
...
`zabadev` auto-detects prerequisites before installation and provides platform-specific guidance:
