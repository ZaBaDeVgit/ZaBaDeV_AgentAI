...
# ============================================================================
# zabadev — Senior ZaBaDeV Installer
# One command to install Senior ZaBaDeV on OpenCode.
#
# Usage:
#   curl -sL https://raw.githubusercontent.com/zabadev/agent-ai/main/scripts/install.sh | bash
#
# Or download and run:
#   curl -sLO https://raw.githubusercontent.com/zabadev/agent-ai/main/scripts/install.sh
#   chmod +x install.sh
#   ./install.sh
# ============================================================================
...
# Examples:
#   zabadev_1.0.0_darwin_arm64.tar.gz
#   zabadev_1.0.0_linux_amd64.tar.gz
# ============================================================================
...
print_banner() {
    ...
    echo -e "${NC}"
    echo -e "  ${DIM}Senior ZaBaDeV Installer — One command, fully configured${NC}"
    echo ""
}
...
print_next_steps() {
    ...
    echo ""
    echo -e "${BOLD}Senior ZaBaDeV is now installed on OpenCode with:${NC}"
    echo -e "  ${CYAN}•${NC} Engram (persistent memory)"
    echo -e "  ${CYAN}•${NC} SDD workflow (Spec-Driven Development)"
    echo -e "  ${CYAN}•${NC} Full skill set"
    echo -e "  ${CYAN}•${NC} Context7 MCP server"
    echo -e "  ${CYAN}•${NC} GGA (Global Agent)"
    echo -e "  ${CYAN}•${NC} Security-first permissions"
    echo ""
    echo -e "${DIM}Run 'zabadev' to install/update or 'zabadev --help' for options${NC}"
    echo ""
}
