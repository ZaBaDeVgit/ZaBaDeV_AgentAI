...
|---------------|-------------|-------------------|
| **ZaBaDeV Mode** | "Your own ZaBaDeV!" — The Senior Architect mentor who teaches, challenges, and pushes you to understand concepts before code. Rioplatense Spanish for Spanish input, direct English otherwise. Uses Tony Stark/Jarvis analogies. | Full persona in CLAUDE.md / opencode agents / .cursorrules, custom thinking verbs, teaching-first behavior |
...
| Thinking verbs | Custom spinner text — Rioplatense phrases like "Tomando un Cafecito mientras Pienso" (only with ZaBaDeV persona) |
...
- R-CONFIG-07: Thinking verbs and Rioplatense expressions MUST only be configured when ZaBaDeV persona is selected
