# Contributing to ZaBaDeV

Thank you for your interest in contributing to **ZaBaDeV** — a Go TUI installer for AI agent environments.
...
1. **Open an issue** using the appropriate template ([Bug Report](https://github.com/ZaBaDeVgit/ZaBaDeV_AgentAI/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/ZaBaDeVgit/ZaBaDeV_AgentAI/issues/new?template=feature_request.yml))
...
```bash
git clone https://github.com/ZaBaDeVgit/ZaBaDeV_AgentAI.git
cd ZaBaDeV_AgentAI
go build -o zabadev .
```
...
Use [GitHub Discussions](https://github.com/ZaBaDeVgit/ZaBaDeV_AgentAI/discussions) — not issues — for questions, ideas, and general conversation.
